...
class PairformerBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.tri_attn_start = TriangleAttention(
            c_z, **triangle_attention, start_node=True)
        self.tri_attn_end = TriangleAttention(
            c_z, **triangle_attention, start_node=False)
        ...
        if c_s > 0:
            ...
            self.attention_pair_bias = AttentionPairBiasPairformerDeepspeed(c_a=c_s, c_s=0, c_pair=c_z, **attention_pair_bias)
...
class InputFeatureEmbedder(nn.Module):
    def __init__(self,
        ...
        super().__init__()
        self.atom_attention_encoder = AtomAttentionEncoderPairformer(c_atom=c_atom, c_atompair=c_atompair, c_s=0, **atom_attention_encoder)
