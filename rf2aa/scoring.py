...
type2ljlk = {
    ...
    "Phos": (2.1500, 0.5850, -4.1000, 3.5000, 14.7000),
    ...
    "genAl": (1.8, 0.1, 0.0000, 3.5000, 0.0000),
    "genAs": (1.8, 0.1, 0.0000, 3.5000, 0.0000),
    "genAu": (1.7, 0.1, 0.0000, 3.5000, 0.0000),
    "genB": (1.9, 0.1, 0.0000, 3.5000, 0.0000),
    "genBe": (1.5, 0.1, 0.0000, 3.5000, 0.0000),
    "genBr": (2.1971, 0.1090, 2.7951, 3.5000, 19.6876),
    "genC": (2.0067, 0.0689, 2.2256, 3.5000, 10.6860),  # params from CT
    "genCa": (2.3, 0.1, 0.0000, 3.5000, 0.0000),
    "genCl": (1.8, 0.1, 0.0000, 3.5000, 0.0000),
    "genCo": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genCr": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genCu": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genF": (1.6941, 0.0750, 1.6442, 3.5000, 12.2163),
    "genFe": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genHg": (1.6, 0.1, 0.0000, 3.5000, 0.0000),
    "genI": (2.3600, 0.1110, 3.1361, 3.5000, 22.0891),
    "genIr": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genK": (2.8, 0.1, 0.0000, 3.5000, 0.0000),
    "genLi": (1.8, 0.1, 0.0000, 3.5000, 0.0000),
    "genMg": (1.7, 0.1, 0.0000, 3.5000, 0.0000),
    "genMn": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genMo": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genN": (1.7854, 0.1497, -6.3760, 3.5000, 9.5221),  # params from NG2
    "genNi": (1.6, 0.1, 0.0000, 3.5000, 0.0000),
    "genO": (1.5492, 0.1576, -3.5363, 3.5000, 10.7220),  # params for OG3
    "genOs": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genP": (2.1290, 0.5838, -9.6272, 3.5000, 34.8000),  # params for PG5
    "genPb": (2.0, 0.1, 0.0000, 3.5000, 0.0000),
    "genPd": (1.6, 0.1, 0.0000, 3.5000, 0.0000),
    "genPr": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genPt": (1.8, 0.1, 0.0000, 3.5000, 0.0000),
    "genRe": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genRh": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genRu": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genS": (1.9893, 0.3634, -2.3560, 3.5000, 17.6400),  # params for SG3
    "genSb": (2.1, 0.1, 0.0000, 3.5000, 0.0000),
    "genSe": (1.9, 0.1, 0.0000, 3.5000, 0.0000),
    "genSi": (2.1, 0.1, 0.0000, 3.5000, 0.0000),
    "genSn": (2.2, 0.1, 0.0000, 3.5000, 0.0000),
    "genTb": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genTe": (2.1, 0.1, 0.0000, 3.5000, 0.0000),
    "genU": (1.9, 0.1, 0.0000, 3.5000, 0.0000),
    "genW": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genV": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genY": (1.8, 0.1, 0.0000, 3.5000, 0.0000),
    "genZn": (1.4, 0.1, 0.0000, 3.5000, 0.0000),
    "genATM": (0.0, 0.0, 0.0000, 3.5000, 0.0000),  # masked, no vdw
}
