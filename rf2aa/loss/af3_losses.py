...
class DiffusionLoss(nn.Module):
    ...
    def forward(self, network_input, network_output, loss_input):
        ...
        l_diffusion_total = torch.sum(l_diffusion)
        # smoothed lddt loss
        ...
        l_diffusion_total += smoothed_lddt_loss_.sum()
        loss_dict = {
...
def smoothed_lddt_loss(X_L, X_gt_L_aligned, crd_mask_L, is_dna, is_rna, tok_idx):
    """
