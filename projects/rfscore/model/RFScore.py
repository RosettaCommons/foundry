...
class RFScore(AF3):
    ...
    def __init__(self, **kwargs):
        ...
        use_fourier_encoding = kwargs["recycler"]["template_embedder"].pop("use_fourier_encoding")

        super().__init__(**kwargs)

        # ... add back the use_fourier_encoding to the kwargs (since it's needed for RFScoreTemplateEmbedder)
        kwargs["recycler"]["template_embedder"]["use_fourier_encoding"] = use_fourier_encoding
